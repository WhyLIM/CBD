...
<body>
    ...
    $query = 'SELECT 
          ...
          FROM
          biomarker
		  WHERE Category="Circular RNA" or Category="LncRNA" or Category="MicroRNA"  or Category="ncRNA"  or Category="Small nucleolar RNAs (snoRNAs)"
          ORDER BY 
          ID ASC';
